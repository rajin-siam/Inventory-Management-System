...
<body>
    <div class="group">
        <div class="dash"><p><a href="./dashboard.php" style="text-decoration: none;">Go to Dashboard</a></p></div>  
        ...
        <tbody>
            ...
            if(isset($_POST['search-button']))
            {
                ...
                if(empty($items))
                {
                    ...
                    echo '<META HTTP-EQUIV="Refresh" CONTENT="1; URL=http://localhost/finalproject/action.php">';
                }
            }
